        ...
        while (keepGoing) {
            ...
            switch (operation) {
                ...
                case 8:  // print tree
                    ...
                    switch (order) {
                        case 1:
                            treeSize = tree.reset(BST.PREORDER);
                            System.out.println("The tree in Preorder is:");
                            for (int count = 1; count <= treeSize; count++) {
                                element = tree.getNext(BST.PREORDER);
                                System.out.println(element);
                            }
                            break;

                        case 2:
                            treeSize = tree.reset(BST.INORDER);
                            System.out.println("The tree in Inorder is:");
                            for (int count = 1; count <= treeSize; count++) {
                                element = tree.getNext(BST.INORDER);
                                System.out.println(element);
                            }
                            break;

                        case 3:
                            treeSize = tree.reset(BST.POSTORDER);
                            System.out.println("The tree in Postorder is:");
                            for (int count = 1; count <= treeSize; count++) {
                                element = tree.getNext(BST.POSTORDER);
                                System.out.println(element);
                            }
                            break;
